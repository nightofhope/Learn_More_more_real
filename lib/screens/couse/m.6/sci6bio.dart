...
class sci6bio extends StatelessWidget {
  const sci6bio({Key? key}) : super(key: key);
...
//บท1
  Container m61scibio(BuildContext context) {
    return Container(
...
//บท2
  Container m62scibio(BuildContext context) {
    return Container(
        constraints: BoxConstraints.expand(height: 50),
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(16), color: Colors.blue[200]),
        child: FlatButton(
          child: Text("ความหลากหลายทางชีวภาพ",
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 18, color: Colors.white)),
          textColor: Colors.white,
          color: Colors.transparent,
